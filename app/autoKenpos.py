...
class autoKenpos(object):
    ...
    def Login(self):
        ...
        self.browser.get('https://pepup.life/scsk_mileage_campaigns/2020/2')
        ...
        # .次の要素を探して1.~4.を繰り返す
        '''
        STEP_XPATH = '//*[@id="app"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div[1]/div[2]/div[2]//*[contains(@class, "hpBiPN")]'
        print("STEP START")
        random.random()
        while True:
            try:
        ...
        SLEEPTIME_PATH = '//*[@id="app"]/div/div[2]/div/div[2]/div/div[3]/div[2]/div[1]/div[2]/div[2]//*[contains(@class,"hpBiPN")]'
        ...
        SLEEPCHECK_PATH = '//*[@id="app"]/div/div[2]/div/div[2]/div/div[4]/div[2]/div[1]/div[2]/div[2]//*[contains(@class,"hpBiPN")]'
        while True:
            try:
        ...
        LIFEWORK_PATH = '//*[@id="app"]/div/div[2]/div/div[2]/div/div[6]/div[2]/div[1]/div[2]/div[2]//*[contains(@class,"hpBiPN")]'
        while True:
            try:
        ...
        ORAL_PATH = '//*[@id="app"]/div/div[2]/div/div[2]/div/div[7]/div[2]/div[1]/div[2]/div[2]//*[contains(@class,"hpBiPN")]'
        while True:
            try:
                isFound = self.browser.find_element_by_xpath(ORAL_PATH)
            except exceptions.NoSuchElementException:
                break
